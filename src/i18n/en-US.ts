...
export default {
    ...
    lbsSubtitle: "My main suite of applications, fully developed with Node.js and TypeScript. This integrated ecosystem includes the main LifeBusinessSuit repository and satellite microservices/apps like LBS_TodoAPP, LBS_NotesAPP, LBS_TTSAPP, and LBS_MoneyAPP, forming a complete productivity and finance solution.",
