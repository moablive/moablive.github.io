...
export default {
    ...
    lbsSubtitle: "Minha suíte de aplicativos principais, totalmente desenvolvida com Node.js e TypeScript. Este ecossistema integrado inclui o repositório principal do LifeBusinessSuit e microsserviços/apps satélites como LBS_TodoAPP, LBS_NotesAPP, LBS_TTSAPP e LBS_MoneyAPP, formando uma solução completa de produtividade e finanças.",
