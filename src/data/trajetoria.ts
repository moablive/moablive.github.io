...
export const empreitadas: Cargo[] = [
    {
        ...
        tags: [{ i18n: "tagOwnCompany" }, "Cloudflare", "Pix"],
        atual: true,
        paralelo: true,
        modal: {
            ...
            itensKeys: ["awlB1", "awlB2", "awlB3", "awlB4", "awlB5", "awlB6"],
            techTituloKey: "modalTech",
            destaque: "success",
            links: [
                { href: "https://astralwavelabel.com", i18n: "awlBtnSite", primario: true },
                { href: "https://www.linkedin.com/company/astralwave/posts/", i18n: "awlBtnLinkedin" },
            ],
            techs: [
                { texto: ".NET Core", variante: "bg-dark" },
                { texto: "Node.js", variante: "bg-dark" },
                { texto: "Go", variante: "bg-dark" },
                { texto: "React", variante: "bg-primary" },
                { texto: "Vue.js", variante: "bg-primary" },
                { texto: "Docker", variante: "bg-primary" },
                { texto: "Cloudflare (WAF, CDN, DNS)", variante: "bg-secondary" },
                { texto: "SQL", variante: "bg-secondary" },
                { texto: "Clean Architecture", variante: "bg-secondary" },
                { texto: "DDD", variante: "bg-secondary" },
                { texto: "REST APIs", variante: "bg-secondary" },
                { texto: "Pix", variante: "bg-secondary" },
                { texto: "Git", variante: "bg-secondary" },
            ],
        },
    },
];
